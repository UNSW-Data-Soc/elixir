    ...
    return (
        <>
            ...
            <small className="text-default-500 flex w-full flex-col items-center justify-center align-baseline">
                Deleting this tag will remove all {props.numRefences} references to this tag.
            </small>
...
function TagModification(props: {tagReference: TagReferences, handleTagUpdate: (updatedTagReference: TagReferences) => void}) {
    ...
    async function handleTagUpdate() {
        ...
        await endpoints.tags.update({id: props.tagReference.tags_id, name, colour }).then(tag =>{
