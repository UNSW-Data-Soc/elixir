...
//       let [tags, bearers] = await Promise.all([
//         endpoints.tags.getAll(),
//         getExistingBearers(),
//       ]);
...
//           let newAttachedDetails = await Promise.all(
//             to_attach.map((a) => endpoints.tags.attach(a)),
//           );

//           let updatedAttachedDetails: AttachmentInfo[] = attachedDetails.filter(
//             (ad) => {
...
//             },
//           );
//           updatedAttachedDetails =
//             updatedAttachedDetails.concat(newAttachedDetails);
