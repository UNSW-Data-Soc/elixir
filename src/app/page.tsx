...
export default function Home() {
  return (
    <>
      ...
      <div className="m-3 flex items-center justify-center p-12 align-baseline">
        <div className="flex flex-col items-center justify-center gap-1 align-baseline text-2xl italic">
          <p>UNSW DataSoc</p>
          <p>Uniting students with a passion for data science,</p>
